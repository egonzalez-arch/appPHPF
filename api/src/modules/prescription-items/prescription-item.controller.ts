...
export class PrescriptionItemController {
  ...
  @Post()
  create(@Body() dto: CreatePrescriptionItemDto) { return this.service.create(dto); }

  @Patch(':id')
  update(@Param('id') id: string, @Body() dto: UpdatePrescriptionItemDto) { return this.service.update(id, dto); }
