...
export class FamilyHistoryController {
  ...
  @Post()
  create(@Body() dto: CreateFamilyHistoryDto) { return this.service.create(dto); }

  @Patch(':id')
  update(@Param('id') id: string, @Body() dto: UpdateFamilyHistoryDto) { return this.service.update(id, dto); }
